...
$data = mysqli_query($conn, "SELECT * FROM tabletia2 WHERE id_tia2 ='".$_GET['id']."'");
    ...
    <form action="" method="POST" enctype="multipart/form-data">
        ...
        <table>
            ...
            <tr>
                <td></td>
                <td></td>
                <td> <img src="img/<?php echo $file ?>" width="400px" height="400px"> </td>
            </tr>
            <tr>
            ...
            if (isset($_POST['kirim'])) {
                ...
                if ($nama_file != '') {
                    ...
                    /*   $update = mysqli_query($conn, "UPDATE tabletia2 SET nama = '" . $nama . "' "); */
                    $update = mysqli_query($conn, "UPDATE tabletia2 SET 
                            nama = '".$nama."',
                            WHERE id_tia2 = '".$_GET['id']."'");
                    if ($update) {
